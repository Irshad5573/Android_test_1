class Game {
  constructor(){
    this.gardenf = createSprite(380,2450,10,9999);
    this.gardenf1 = createSprite(380,-7800,10,9999);
    }
  ...
  async start(){
    ...
    player1 = createSprite(windowWidth/2,100);
    ...
    life4.visible= false;
    life5.visible= false;
    virus=createSprite(windowWidth/2,400);
  }

  hide(){
    //this.up.hide();
    this.gardenf.visible=false;
    this.gardenf1.visible=false;
    game.play.visible=false
...
//    this.up = createButton('UP');
    ...
    gardenEntrence = createSprite(255,-2695,200,400);

    player1.collide(this.gardenf);
    player1.collide(this.gardenf1);
   ...
   // virus.x=player1.x ;
    ...
    image(road_img,windowWidth/4,-windowHeight*400,800,windowHeight*99999);
   ...
   /* this.up.position(windowWidth/2+500,windowWidth-1000)
